...
namespace Multimeter_Controller
{
  public partial class Settings_Form : Form
  {
    ...
    private TextBox Prologix_IP_Textbox;
    private NumericUpDown Prologix_Port_Numeric;
    private TextBox Prologix_MAC_Textbox;
    private NumericUpDown Prologix_GPIB_Address_Numeric;
    ...
    private TextBox Prologix_Subnet_Textbox;
    ...
    private ComboBox _Default_NPLC_3458A_Combo;
    ...
    private void Build_Prologix_Tab ( )
    {
      ...
      Prologix_IP_Textbox = new TextBox
      {
        Location = new Point ( Right_Col, Y - 2 ),
        Size = new Size ( 150, 23 )
      };
      Prologix_Tab.Controls.Add ( Prologix_IP_Textbox );
      Y += Row_H;
      ...
      Prologix_Subnet_Textbox = new TextBox
      {
        Location = new Point ( Right_Col, Y - 2 ),
        Size = new Size ( 150, 23 )
      };
      Prologix_Tab.Controls.Add ( Prologix_Subnet_Textbox );
      Prologix_Tab.Controls.Add ( new Label
      {
      ...
      Prologix_Port_Numeric = new NumericUpDown
      {
        Location = new Point ( Right_Col, Y - 2 ),
        Size = new Size ( 80, 23 ),
        Minimum = 1,
      ...
      Prologix_Tab.Controls.Add ( Prologix_Port_Numeric );
      Y += Row_H;
      ...
      Prologix_MAC_Textbox = new TextBox
      {
        Location = new Point ( Right_Col, Y - 2 ),
        Size = new Size ( 150, 23 )
      };
      Prologix_Tab.Controls.Add ( Prologix_MAC_Textbox );
      Prologix_Tab.Controls.Add ( new Label
      {
        Text = "(e.g. 00-1C-4A)",
        Location = new Point ( Right_Col + 160, Y ),
      ...
      Prologix_GPIB_Address_Numeric = new NumericUpDown
      {
        Location = new Point ( Right_Col, Y - 2 ),
        Size = new Size ( 80, 23 ),
        Minimum = 0,
      ...
      Prologix_Tab.Controls.Add ( Prologix_GPIB_Address_Numeric );
      Prologix_Tab.Controls.Add ( new Label
      {
        Text = "(0 - 30)",
    ...
    private void Initialize_HP_Tab ( )
    {
      ...
      HP3458A_Tab.Controls.Add ( Scroll_Panel );  // ← missing
      ...
      _Default_NPLC_3458A_Combo = new ComboBox
      {
        Location = new Point ( 250, Y - 3 ),
        Size = new Size ( 100, 23 ),
        DropDownStyle = ComboBoxStyle.DropDownList
      };
      _Default_NPLC_3458A_Combo.Items.AddRange (
          new object [ ] { "0.001", "0.01", "0.1", "1", "2", "10", "100" } );
      Scroll_Panel.Controls.Add ( _Default_NPLC_3458A_Combo );
      Y += 30;
    ...
    {
      // HP tab
      _Send_Reset_On_Connect_Check.Checked = _Settings.Send_Reset_On_Connect_3458A;
      _Reset_Delay_Numeric.Value = _Settings.Reset_Settle_Delay_Ms;
      _Send_End_Always_Check.Checked = _Settings.Send_End_Always_3458A;
      ...
      _Default_NPLC_3458A_Combo.SelectedItem = _Settings.Default_NPLC_3458A;
      _Default_Trig_Mode_Combo.SelectedItem = _Settings.Default_Trig_Mode_3458A;
      
      


      Prologix_IP_Textbox.Text = _Settings.Default_IP_Address;
      Prologix_Port_Numeric.Value = _Settings.Default_Prologic_Port;
      Prologix_MAC_Textbox.Text = _Settings.Prologic_MAC_Address;
      Prologix_GPIB_Address_Numeric.Value = _Settings.Default_GPIB_Instrument_Address;
      ...
      Prologix_Subnet_Textbox.Text = _Settings.Network_Scan_Subnet;
    ...
    private void Save_Settings ( )
    {
      ...
      // HP tab
      _Settings.Send_Reset_On_Connect_3458A = _Send_Reset_On_Connect_Check.Checked;
      _Settings.Reset_Settle_Delay_Ms = (int) _Reset_Delay_Numeric.Value;
      _Settings.Send_End_Always_3458A = _Send_End_Always_Check.Checked;
      ...
      _Settings.Default_NPLC_3458A = _Default_NPLC_3458A_Combo.SelectedItem?.ToString ( ) ?? "1";
      _Settings.Default_Trig_Mode_3458A = _Default_Trig_Mode_Combo.SelectedItem?.ToString ( ) ?? "TRIG AUTO";
      ...
      _Settings.Default_IP_Address = Prologix_IP_Textbox.Text.Trim ( );
      _Settings.Default_Prologic_Port = (int) Prologix_Port_Numeric.Value;
      _Settings.Prologic_MAC_Address = Prologix_MAC_Textbox.Text.Trim ( );
      _Settings.Default_GPIB_Instrument_Address = (int) Prologix_GPIB_Address_Numeric.Value;
      ...
      _Settings.Network_Scan_Subnet = Prologix_Subnet_Textbox.Text.Trim ( ).TrimEnd ( '.' );
