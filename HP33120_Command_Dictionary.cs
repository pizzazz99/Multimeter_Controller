...
namespace Multimeter_Controller
{
  ...
  new Command_Entry( Command: "APPLy:SIN",
                     ...
                     Parameters: ( "freq: 100 uHz to 15 MHz, amp: 10 mVpp to 10 Vpp (50 ohm), " +
                                   "offset: volts" ),
                     Query_Form: "APPLy?",
  ...
  new Command_Entry( Command: "APPLy:SQU",
  ...
  new Command_Entry( Command: "APPLy:TRI",
                     Syntax: "APPLy:TRIangle [<freq>[,<amp>[,<offset>]]]",
                     Description: "Output a triangle wave with specified parameters",
                     Category: Command_Category.Configuration,
                     Parameters: ( "freq: 100 uHz to 100 kHz, amp: 10 mVpp to 10 Vpp (50 ohm), " +
                                   "offset: volts" ),
                     Query_Form: "APPLy?",
                     Default_Value: "1 kHz, 100 mVpp, 0 V",
  ...
  new Command_Entry( Command: "APPLy:RAMP",
  ...
  new Command_Entry( Command: "APPLy:NOIS",
  ...
  new Command_Entry( Command: "APPLy:DC",
  ...
  new Command_Entry( Command: "APPLy:USER",
                     Syntax: "APPLy:USER [<freq>[,<amp>[,<offset>]]]",
                     Description: "Output the currently selected arbitrary waveform",
                     Category: Command_Category.Configuration,
                     Parameters: ( "freq: 100 uHz to 6 MHz, amp: 10 mVpp to 10 Vpp (50 ohm), offset: " +
                                   "volts" ),
                     Query_Form: "APPLy?",
                     Default_Value: "1 kHz, 100 mVpp, 0 V",
  ...
  new Command_Entry( Command: "OUTP:SYNC",
  ...
  new Command_Entry( Command: "FM:DEV",
                     ...
                     Category: Command_Category.Configuration,
                     Parameters: ( "deviation: in Hz|MIN|MAX (carrier +/- deviation must be in " +
                                   "range)" ),
                     Query_Form: "FM:DEV?",
                     Default_Value: "100 Hz",
                     Example: "FM:DEV 5000",
  ...
  new Command_Entry( Command: "BURS:SOUR",
  ...
  new Command_Entry( Command: "MARK:FREQ",
  ...
  new Command_Entry( Command: "MARK:STAT",
  ...
  new Command_Entry( Command: "DATA:DAC",
  ...
  new Command_Entry( Command: "DATA:COPY",
  ...
  new Command_Entry( Command: "DATA:DEL",
                     ...
                     Category: Command_Category.Memory,
                     Parameters: ( "name: waveform name or ALL (built-in waveforms cannot be " +
                                   "deleted)" ),
                     Query_Form: "",
                     Default_Value: "N/A",
  ...
  new Command_Entry( Command: "DATA:CAT?",
                     Syntax: "DATA:CATalog?",
  ...
  new Command_Entry( Command: "DATA:NVOL:FREE?",
  ...
  new Command_Entry( Command: "FUNC:USER",
  ...
  new Command_Entry( Command: "PHAS",
  ...
  new Command_Entry( Command: "PHAS:REF",
    ...
    public class Test_Profile : IInstrument_Test_Profile
    {
      ...
      public List<Command_Entry> Get_Commands() =>
        HP33120_Command_Dictionary_Class.Get_All_Commands();

      public IEnumerable<Command_Test_Result> Run_Sequences( Func<string, string> Query,
                                                             Action<string> Send )
      {
        foreach (var R in Test_Output_Sequence( Query, Send ))
          yield return R;
      }

      private static IEnumerable<Command_Test_Result> Test_Output_Sequence(
        Func<string, string> Query,
        Action<string> Send )
      {
        var Seq_Cmd = new Command_Entry(
          Command: "OUTP [sequence]",
          Syntax: "FUNC SIN → FREQ → VOLT → OUTP ON → FREQ? → OUTP OFF",
          Description: "Sequenced output enable/disable test",
          Category: Command_Category.Configuration,
          Test_Behavior: Test_Behavior.Requires_Sequence );
        ...
        try
        {
          ...
          bool OK = double.TryParse( Freq,
                                         System.Globalization.NumberStyles.Float,
                                         System.Globalization.CultureInfo.InvariantCulture,
                                         out _ );
          Result = OK
            ? Command_Test_Result.Pass( Seq_Cmd, $"FREQ={Freq.Trim()} output enabled" )
            : Command_Test_Result.Fail( Seq_Cmd, $"Non-numeric FREQ? response: {Freq}" );
        }
        catch (Exception Ex)
        {
