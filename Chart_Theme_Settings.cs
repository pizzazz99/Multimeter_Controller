...
// ════════════════════════════════════════════════════════════════════════════════
// FILE:    Chart_Theme_Settings_Form.cs
...
{
  public partial class Chart_Theme_Settings : Form
  {
    ...
    public Chart_Theme_Settings ( Chart_Theme Current )
    {
      InitializeComponent ( );

      _Working = Chart_Theme.Load( Chart_Theme.Chart_Theme_Path );  // ✅ correct path
    ...
    private void Update_Swatches ( )
    {
      ...
      Fg_Swatch.ForeColor = _Working.Foreground;
