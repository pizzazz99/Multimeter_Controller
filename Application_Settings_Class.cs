...
namespace Multimeter_Controller
{
  public class Application_Settings
  {
    ...
    [JsonPropertyName ( "send_reset_on_connect_3458a" )]
    public bool Send_Reset_On_Connect_3458A { get; set; } = true;

    [JsonPropertyName ( "reset_settle_delay_ms" )]
    public int Reset_Settle_Delay_Ms { get; set; } = 2000;

    [JsonPropertyName ( "send_end_always_3458a" )]
    public bool Send_End_Always_3458A { get; set; } = true;
    ...
    [JsonPropertyName ( "default_nplc_3458a" )]
    public string Default_NPLC_3458A { get; set; } = "1";

    [JsonPropertyName ( "default_trig_mode_3458a" )]
    public string Default_Trig_Mode_3458A { get; set; } = "TRIG HOLD";
    ...
    public string Network_Scan_Subnet { get; set; } = "192.168.1";

    [JsonPropertyName ( "default_ip_address" )]
    public string Default_IP_Address { get; set; } = "192.168.1.177";
