    ...
    public static class HP33220_Command_Dictionary_Class
    {
        ...
        var Commands = new List<Command_Entry>
      {
        ...
        new Command_Entry (
          ...
          Parameters:    "frequency: 1e-6 to 20e6 Hz | DEF | MIN | MAX, amplitude: 10e-3 to 10 Vpp | DEF, offset: -5 to +5 V | DEF",
          Query_Form:    "APPL?",
        ...
        new Command_Entry (
          ...
          Category:      Command_Category.Configuration,
          Parameters:    "frequency: 1e-6 to 20e6 Hz | DEF | MIN | MAX, amplitude: 10e-3 to 10 Vpp | DEF",
          Query_Form:    "APPL?",
          Default_Value: "1000 Hz, 1 Vpp, 0 V offset",
        ...
        new Command_Entry (
          ...
          Category:      Command_Category.Configuration,
          Parameters:    "frequency: 1e-6 to 200e3 Hz | DEF | MIN | MAX, amplitude: 10e-3 to 10 Vpp | DEF",
          Query_Form:    "APPL?",
          Default_Value: "1000 Hz, 1 Vpp, 0 V offset",
        ...
        new Command_Entry (
          ...
          Category:      Command_Category.Configuration,
          Parameters:    "frequency: 500e-6 to 5e6 Hz | DEF | MIN | MAX, amplitude: 10e-3 to 10 Vpp | DEF",
          Query_Form:    "APPL?",
          Default_Value: "1000 Hz, 1 Vpp, 0 V offset",
        ...
        new Command_Entry (
          ...
          Category:      Command_Category.Configuration,
          Parameters:    "frequency: 1e-6 to 6e6 Hz | DEF | MIN | MAX, amplitude: 10e-3 to 10 Vpp | DEF",
          Query_Form:    "APPL?",
          Default_Value: "1000 Hz, 1 Vpp, 0 V offset",
        ...
        new Command_Entry (
          ...
          Category:      Command_Category.Configuration,
          Parameters:    "frequency: 1e-6 to 20e6 Hz | MIN | MAX (limit depends on waveform)",
          Query_Form:    "FREQ?",
          Default_Value: "1000",
          Example:       "FREQ 10e6" ),
        ...
        new Command_Entry (
          ...
          Category:      Command_Category.Configuration,
          Parameters:    "offset: -5 to +5 V (into 50 Ohm, limited by amplitude) | MIN | MAX",
        ...
        new Command_Entry (
          ...
          Description:   "Set waveform high level directly (alternative to amplitude + offset)",
          Category:      Command_Category.Configuration,
        ...
        new Command_Entry (
          ...
          Description:   "Set waveform low level directly (alternative to amplitude + offset)",
          Category:      Command_Category.Configuration,
        ...
        new Command_Entry (
          Command:       "VOLT:RANG:AUTO",
          Syntax:        "VOLTage:RANGe:AUTO <mode>",
          Description:   "Enable or disable automatic amplitude ranging (affects attenuator switching)",
          Category:      Command_Category.Configuration,
        ...
        new Command_Entry (
          ...
          Description:   "Set expected output load impedance (affects displayed amplitude)",
          Category:      Command_Category.Configuration,
        ...
        new Command_Entry (
          ...
          Description:   "Set ramp wave symmetry (0% = sawtooth, 100% = triangle, 50% = default ramp)",
          Category:      Command_Category.Configuration,
        ...
        new Command_Entry (
          ...
          Description:   "Select a named arbitrary waveform from memory as the active USER waveform",
          Category:      Command_Category.Configuration,
          Parameters:    "waveform_name: name string of a waveform stored in volatile or non-volatile memory",
          Query_Form:    "FUNC:ARB?",
          Default_Value: "N/A",
        ...
        new Command_Entry (
          ...
          Description:   "Download floating-point arbitrary waveform data to volatile memory",
          Category:      Command_Category.Configuration,
          Parameters:    "waveform_name: string, data_values: comma-separated floats -1.0 to +1.0 (min 8, max 65536 points)",
          Query_Form:    "",
          Default_Value: "N/A",
          Example:       "DATA:ARB MYWAVE,0.0,0.5,1.0,0.5,0.0,-0.5,-1.0,-0.5" ),

        new Command_Entry (
          Command:       "DATA:ARB:DAC",
          ...
          Category:      Command_Category.Configuration,
          Parameters:    "waveform_name: string, dac_values: comma-separated integers 0 to 65535",
          Query_Form:    "",
          Default_Value: "N/A",
          Example:       "DATA:ARB:DAC MYWAVE,32767,49151,65535,49151,32767,16383,0,16383" ),

        new Command_Entry (
          Command:       "MMEM:STOR:DATA",
          Syntax:        "MMEMory:STORe:DATA <waveform_name>,\"<filename>\"",
          Description:   "Save arbitrary waveform from volatile memory to non-volatile file",
          Category:      Command_Category.Configuration,
        ...
        new Command_Entry (
          Command:       "MMEM:LOAD:DATA",
          Syntax:        "MMEMory:LOAD:DATA <waveform_name>",
          Description:   "Load arbitrary waveform from non-volatile file into volatile memory",
          Category:      Command_Category.Configuration,
        ...
        new Command_Entry (
          ...
          Description:   "Enable or disable PWM (pulse width modulation) — pulse waveform only",
          Category:      Command_Category.Modulation,
          Parameters:    "mode: ON | OFF",
          Query_Form:    "PWM:STAT?",
          Default_Value: "OFF",
        ...
        new Command_Entry (
          ...
          Description:   "Recall instrument state from a named file in non-volatile memory",
          Category:      Command_Category.Memory,
          Parameters:    "register: 0–4, filename: quoted path string",
          Query_Form:    "",
          Default_Value: "N/A",
