    ...
    public static class HP34411_Command_Dictionary_Class
    {
        ...
        var Commands = new List<Command_Entry>
      {
        ...
        new Command_Entry (
          Command:       "DATA:LAST?",
          Syntax:        "DATA:LAST?",
          Description:   "Return most recently completed reading without disturbing trigger state",
          Category:      Command_Category.Measurement,
          Parameters:    "None",
        ...
        new Command_Entry (
          Command:       "VOLT:DC:APER",
          Syntax:        "VOLTage:DC:APERture <seconds>",
          Description:   "Set DC voltage integration time in seconds (alternative to NPLC)",
          Category:      Command_Category.Configuration,
        ...
        new Command_Entry (
          ...
          Description:   "Set sample interval when SAMP:SOUR is TIMer (min 20 µs = 50k rdgs/sec)",
          Category:      Command_Category.Trigger,
