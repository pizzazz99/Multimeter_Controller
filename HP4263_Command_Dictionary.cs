    ...
    public static class HP4263_Command_Dictionary_Class
    {
        ...
        var Commands = new List<Command_Entry>
      {
        ...
        new Command_Entry (
          ...
          Description:   "One-shot impedance measurement — configure, trigger, and return primary + secondary values",
        ...
        new Command_Entry (
          Command:       "READ?",
          Syntax:        "READ?",
          Description:   "Trigger measurement and return primary value, secondary value, and status",
          Category:      Command_Category.Measurement,
        ...
        new Command_Entry (
          Command:       "FETCH?",
          Syntax:        "FETCH?",
          Description:   "Return last completed measurement without re-triggering (returns primary,secondary,status)",
          Category:      Command_Category.Measurement,
          Parameters:    "None (status: 0=normal, 1=pri overrange, 2=sec overrange, 3=both, 4=overload)",
          Query_Form:    "FETCH?",
          Default_Value: "N/A",
          Example:       "FETCH?" ),
        ...
        new Command_Entry (
          Command:       "FUNC:IMP:TYPE",
          Syntax:        "FUNCtion:IMPedance:TYPE <parameter_pair>",
          Description:   "Select impedance measurement parameter pair (primary + secondary)",
          Category:      Command_Category.Configuration,
          Parameters:    "CPD|CSD|CPQ|CSQ|CPRP|CSRS|LPD|LSD|LPQ|LSQ|LPRP|LSRS|RX|ZTD|ZTR|GB|YTD|YTR|VDID",
        ...
        new Command_Entry (
          ...
          Description:   "Set cable length for compensation — affects parasitic correction model",
          Category:      Command_Category.Configuration,
        ...
        new Command_Entry (
          ...
          Description:   "Perform open compensation measurement at current frequency (stores raw data)",
        ...
        new Command_Entry (
          ...
          Description:   "Execute open compensation — measure and store open-circuit correction data",
          Category:      Command_Category.Compensation,
          Parameters:    "None (connect open-circuit fixture before executing)",
          Query_Form:    "",
          Default_Value: "N/A",
        ...
        new Command_Entry (
          ...
          Description:   "Perform short compensation measurement at current frequency (stores raw data)",
          Category:      Command_Category.Compensation,
        ...
        new Command_Entry (
          Command:       "CORR:SHOR:EXEC",
          Syntax:        "CORRection:SHORt:EXECute",
          Description:   "Execute short compensation — measure and store short-circuit correction data",
          Category:      Command_Category.Compensation,
          Parameters:    "None (connect shorted fixture before executing)",
          Query_Form:    "",
          Default_Value: "N/A",
        ...
        new Command_Entry (
          Command:       "CORR:LOAD:TYPE",
          Syntax:        "CORRection:LOAD:TYPE <parameter_pair>",
          Description:   "Select parameter pair for load compensation reference component",
          Category:      Command_Category.Compensation,
          Parameters:    "parameter_pair: CPD | CSD | CPQ | CSQ | CPRP | CSRS | LPD | LSD | LPQ | LSQ | LPRP | LSRS | RX | ZTD | ZTR | GB | YTD | YTR",
        ...
        new Command_Entry (
          ...
          Description:   "Execute load compensation — measure and store load correction data",
          Category:      Command_Category.Compensation,
        ...
        new Command_Entry (
          ...
          Description:   "Query limit test result for last measurement (0 = pass, 1 = fail)",
          Category:      Command_Category.Math,
