    ...
    public static List<Command_Entry> Get_All_Commands()
    {
      var Commands = new List<Command_Entry>
      {
        ...
        new Command_Entry (
          ...
          Parameters: "No parameters. Precede with S0 (default) for DCV, or S1 for DCV/DCV Ratio.",
          Query_Form: "",
        ...
        new Command_Entry (
          Command: "F3",
          Syntax: "[S0]F3",
          Description: "Select AC+DC voltage measurement function (true RMS of combined signal)",
          Category: Command_Category.Measurement,
          Parameters: "No parameters. Precede with S0 for ACV+DCV, or S1 for ACV+DCV/DCV Ratio.",
          Query_Form: "",
          Default_Value: "Not default",
          Example: "S0F3" ),
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Measurement,
          Parameters: "No parameters. Precede with S0 for 2W Ohms, or S1 for O.C. (Offset Compensated) 2W Ohms.",
          Query_Form: "",
          Default_Value: "Not default",
          Example: "S0F4" ),
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Measurement,
          Parameters: "No parameters. Precede with S0 for 4W Ohms, or S1 for O.C. (Offset Compensated) 4W Ohms.",
          Query_Form: "",
          Default_Value: "Not default",
          Example: "S0F5" ),
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Measurement,
          Parameters: "None. S0 selects: F1=DCV, F2=ACV, F3=ACV+DCV, F4=2W Ohms, F5=4W Ohms.",
          Query_Form: "",
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Measurement,
          Parameters: "None. S1 selects: F1=DCV/DCV Ratio, F2=ACV/DCV Ratio, F3=ACV+DCV/DCV Ratio, F4=O.C. 2W Ohms, F5=O.C. 4W Ohms.",
          Query_Form: "",
        ...
        new Command_Entry (
          ...
          Parameters: "None. Applies to all functions. Upranges at 120% full-scale; downranges below 11% full-scale.",
          Query_Form: "",
        ...
        new Command_Entry (
          Command: "R2",
          Syntax: "R2",
          Description: "Select 100 mV range (volts functions) or 1 kΩ range (ohms functions)",
          Category: Command_Category.Configuration,
        ...
        new Command_Entry (
          Command: "R3",
          Syntax: "R3",
          Description: "Select 1000 mV (1 V) range (volts functions) or 1 kΩ range (ohms functions)",
          Category: Command_Category.Configuration,
        ...
        new Command_Entry (
          Command: "R4",
          Syntax: "R4",
          Description: "Select 10 V range (volts functions) or 10 kΩ range (ohms functions)",
          Category: Command_Category.Configuration,
        ...
        new Command_Entry (
          Command: "R5",
          Syntax: "R5",
          Description: "Select 100 V range (volts functions) or 100 kΩ range (ohms functions)",
          Category: Command_Category.Configuration,
        ...
        new Command_Entry (
          Command: "R6",
          Syntax: "R6",
          Description: "Select 1000 V range (volts functions) or 1 MΩ range (ohms functions)",
          Category: Command_Category.Configuration,
        ...
        new Command_Entry (
          Command: "R9",
          Syntax: "R9",
          Description: "Select 1000 MΩ (1 GΩ) range (ohms functions only; invalid for voltage)",
          Category: Command_Category.Configuration,
        ...
        new Command_Entry (
          Command: "STI",
          Syntax: "<value>STI",
          Description: "Store number of power line cycles (NPLC / integration time) into register I",
          Category: Command_Category.Configuration,
          Parameters: "value: 1 to 100 (integer). Front panel exposes 1, 10, 100 only. Recommended via HP-IB: 1 | 2 | 4 | 8 | 16 | 32 | 64 | 100. Default: 100.",
          Query_Form: "REI",
          Default_Value: "100",
          Example: "100STI" ),
        ...
        new Command_Entry (
          Command: "REI",
          Syntax: "REI",
          Description: "Recall (query) the current integration time register I (NPLC setting)",
          Category: Command_Category.Configuration,
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Configuration,
          Parameters: "value: 3|4|5|6 (digits displayed; 6 = maximum 6.5-digit resolution)",
          Query_Form: "REG",
          Default_Value: "6",
          Example: "6STG" ),
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Configuration,
          Parameters: "value: 0.0 to 999.9 seconds. Inserted between trigger and start of measurement.",
          Query_Form: "RED",
          Default_Value: "0",
          Example: "0.5STD" ),
        ...
        new Command_Entry (
          Command: "Z0",
          Syntax: "Z0",
          Description: "Disable autozero (single offset measurement taken at mode change; no per-reading zeroing)",
          Category: Command_Category.Configuration,
          Parameters: "None. Disabling autozero increases reading rate; useful for high-impedance measurements (eliminates input switching).",
          Query_Form: "",
        ...
        new Command_Entry (
          Command: "Z1",
          Syntax: "Z1",
          Description: "Enable autozero (instrument shorts input and takes an offset reading before each measurement)",
          Category: Command_Category.Configuration,
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Configuration,
          Parameters: "None. Filter is a 3-pole active filter with >60 dB attenuation at ≥50 Hz.",
          Query_Form: "",
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Configuration,
          Parameters: "None. In ACV or ACV+DCV mode, filter is applied to the AC converter output. Recommended for measurements below 400 Hz.",
          Query_Form: "",
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Configuration,
          Parameters: "Format: +RDDDDDDDD+D[CR][LF] where R=overrange flag (0/1), DDDDDDDD=7 mantissa digits, +D=signed exponent. Readings separated by commas when N>1.",
          Query_Form: "",
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Configuration,
          Parameters: "Format: 4 bytes: [exponent+sign+OR][BCD12][BCD34][BCD56]. Decimal point implicit at OR bit. Faster transfer than P0.",
          Query_Form: "",
        ...
        new Command_Entry (
          Command: "T1",
          Syntax: "T1",
          Description: "Select internal auto-trigger mode (instrument triggers continuously and automatically)",
          Category: Command_Category.Trigger,
          Parameters: "None. Instrument repeats measurements at maximum rate determined by integration time and function.",
          Query_Form: "",
        ...
        new Command_Entry (
          Command: "T2",
          Syntax: "T2",
          Description: "Select external trigger mode (measurement triggered by hardware signal on rear-panel EXT TRIG input)",
          Category: Command_Category.Trigger,
          Parameters: "None. Negative TTL edge on EXT TRIG initiates measurement. If triggered during an active measurement cycle, the cycle is aborted and restarted.",
          Query_Form: "",
          Default_Value: "Not default",
          Example: "T2" ),
        ...
        new Command_Entry (
          Command: "T3",
          Syntax: "T3",
          Description: "Software single trigger — executes one measurement cycle when this code is sent",
          Category: Command_Category.Trigger,
          Parameters: "None. Sends a single trigger to the instrument immediately when parsed. Can be used within a stored program.",
          Query_Form: "",
          Default_Value: "Not default",
          Example: "T3" ),
        ...
        new Command_Entry (
          Command: "T4",
          Syntax: "T4",
          Description: "Hold mode — instrument waits for a GET (Group Execute Trigger) or T3 command before each measurement",
          Category: Command_Category.Trigger,
          Parameters: "None. Instrument holds in standby until a bus trigger (GET) or an explicit T3 is received.",
          Query_Form: "",
          Default_Value: "Not default",
          Example: "T4" ),
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Trigger,
          Parameters: "value: 1 to 350 (maximum is limited by available reading storage memory). Readings are output as a comma-separated sequence in ASCII mode.",
          Query_Form: "REN",
          Default_Value: "1",
          Example: "10STN" ),
        ...
        new Command_Entry (
          Command: "M1",
          Syntax: "M1",
          Description: "Enable pass/fail math mode — compares reading against lower (L) and upper (U) limit registers",
          Category: Command_Category.Math,
          Parameters: "Requires limits pre-loaded: <low>STL and <high>STU. Outputs reading; SRQ on limit failure if SM bit 200 is set.",
          Query_Form: "",
        ...
        new Command_Entry (
          Command: "M2",
          Syntax: "M2",
          Description: "Enable statistics math mode — accumulates mean, variance, and count over successive readings",
          Category: Command_Category.Math,
          Parameters: "Results in read-only registers: M (mean), V (variance), C (count). Read with REM, REV, REC.",
          Query_Form: "",
          Default_Value: "M0 (OFF is default)",
          Example: "M2" ),
        ...
        new Command_Entry (
          Command: "M3",
          Syntax: "M3",
          Description: "Enable null math mode — subtracts the value stored in register Z from each reading",
          Category: Command_Category.Math,
        ...
        new Command_Entry (
          Command: "M4",
          Syntax: "M4",
          Description: "Enable thermistor math mode — converts resistance reading to temperature in °F",
          Category: Command_Category.Math,
          Parameters: "Instrument uses built-in Steinhart-Hart coefficients for thermistor conversion. Use appropriate ohms function (F4 or F5).",
          Query_Form: "",
          Default_Value: "M0 (OFF is default)",
          Example: "S0F4R1M4" ),
        ...
        new Command_Entry (
          Command: "M5",
          Syntax: "M5",
          Description: "Enable thermistor math mode — converts resistance reading to temperature in °C",
          Category: Command_Category.Math,
          Parameters: "Instrument uses built-in Steinhart-Hart coefficients for thermistor conversion. Use appropriate ohms function (F4 or F5).",
          Query_Form: "",
          Default_Value: "M0 (OFF is default)",
        ...
        new Command_Entry (
          Command: "M6",
          Syntax: "M6",
          Description: "Enable scale math mode — applies formula: result = (reading - Z) / Y",
          Category: Command_Category.Math,
          Parameters: "Load registers: <offset>STZ, <scale_factor>STY. Result = (X - Z) / Y.",
          Query_Form: "",
          Default_Value: "M0 (OFF is default)",
        ...
        new Command_Entry (
          Command: "M7",
          Syntax: "M7",
          Description: "Enable percent error math mode — result = ((reading - Y) / Y) × 100",
          Category: Command_Category.Math,
          Parameters: "Load reference: <nominal>STY. Result is percent deviation from nominal.",
          Query_Form: "",
          Default_Value: "M0 (OFF is default)",
          Example: "5.0STY M7" ),
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Math,
          Parameters: "Load voltage reference: <ref_volts>STY. Result in dB relative to Y.",
          Query_Form: "",
          Default_Value: "M0 (OFF is default)",
          Example: "1.0STY M8" ),
        ...
        new Command_Entry (
          Command: "M9",
          Syntax: "M9",
          Description: "Enable dBm math mode — result = 10 × log10(reading² / R × 1000), where R is the impedance stored in register R",
          Category: Command_Category.Math,
          Parameters: "Load reference impedance: <ohms>STR. Valid impedances: 50–8000 Ω. Result in dBm.",
          Query_Form: "",
          Default_Value: "M0 (OFF is default)",
          Example: "600STR M9" ),
        ...
        new Command_Entry (
          Command: "STL",
          Syntax: "<value>STL",
          Description: "Store value into lower limit register L (used by pass/fail math mode M1)",
          Category: Command_Category.Math,
        ...
        new Command_Entry (
          Command: "STU",
          Syntax: "<value>STU",
          Description: "Store value into upper limit register U (used by pass/fail math mode M1)",
          Category: Command_Category.Math,
        ...
        new Command_Entry (
          Command: "STY",
          Syntax: "<value>STY",
          Description: "Store value into Y register (reference for dB, %error, and scale math modes)",
          Category: Command_Category.Math,
        ...
        new Command_Entry (
          Command: "STZ",
          Syntax: "<value>STZ",
          Description: "Store value into Z register (null offset for null math mode M3, and offset for scale mode M6)",
          Category: Command_Category.Math,
        ...
        new Command_Entry (
          Command: "STR",
          Syntax: "<value>STR",
          Description: "Store value into R register (reference impedance for dBm math mode M9, or general-purpose storage)",
          Category: Command_Category.Math,
          Parameters: "value: impedance in ohms for dBm; 50 to 8000 typical. Also used as general scratch register.",
          Query_Form: "RER",
          Default_Value: "600",
          Example: "50STR" ),
        ...
        new Command_Entry (
          Command: "REM",
          Syntax: "REM",
          Description: "Recall mean register M (read-only result from statistics math mode M2)",
          Category: Command_Category.Math,
          Parameters: "None. Returns mean of all readings accumulated since M2 was enabled.",
          Query_Form: "REM",
        ...
        new Command_Entry (
          Command: "REV",
          Syntax: "REV",
          Description: "Recall variance register V (read-only result from statistics math mode M2)",
          Category: Command_Category.Math,
        ...
        new Command_Entry (
          Command: "REC",
          Syntax: "REC",
          Description: "Recall count register C (read-only result from statistics math mode M2)",
          Category: Command_Category.Math,
        ...
        new Command_Entry (
          Command: "RS0",
          Syntax: "RS0",
          Description: "Disable reading storage (stop storing readings in internal memory)",
        ...
        new Command_Entry (
          Command: "RS1",
          Syntax: "RS1",
          Description: "Enable reading storage (store up to 350 readings in internal circular FIFO memory)",
          Category: Command_Category.Memory,
          Parameters: "None. Memory holds the most recent 350 readings. Oldest readings are overwritten when full.",
          Query_Form: "",
        ...
        new Command_Entry (
          Command: "RER",
          Syntax: "RER",
          Description: "Recall readings from internal storage memory (also used to recall the R register value)",
          Category: Command_Category.Memory,
          Parameters: "None. In reading storage context, outputs stored readings over HP-IB. In math context, returns value of register R.",
          Query_Form: "RER",
          Default_Value: "N/A",
          Example: "RS0 RER" ),
        ...
        new Command_Entry (
          Command: "SO0",
          Syntax: "SO0",
          Description: "Disable system output mode (instrument outputs readings only when addressed to talk)",
        ...
        new Command_Entry (
          Command: "SO1",
          Syntax: "SO1",
          Description: "Enable system output mode (instrument asserts SRQ and outputs reading automatically when data is ready)",
          Category: Command_Category.IO,
          Parameters: "None. Useful for interrupt-driven acquisition; instrument signals controller via SRQ when reading is available.",
          Query_Form: "",
        ...
        new Command_Entry (
          Command: "D0",
          Syntax: "D0",
          Description: "Disable front panel display (blanks the display; reduces EMI and speeds up acquisition slightly)",
          Category: Command_Category.IO,
          Parameters: "None.",
          Query_Form: "",
          Default_Value: "D1 (ON)",
        ...
        new Command_Entry (
          ...
          Category: Command_Category.IO,
          Parameters: "None. Disabling EOI can increase transfer speed in some bus configurations.",
          Query_Form: "",
        ...
        new Command_Entry (
          Command: "O1",
          Syntax: "O1",
          Description: "Enable EOI assertion on last byte of output (default HP-IB behavior)",
          Category: Command_Category.IO,
          Parameters: "None.",
          Query_Form: "",
          Default_Value: "O1 (ON)",
        ...
        new Command_Entry (
          Command: "W",
          Syntax: "W",
          Description: "Word (numeric) separator — used to delimit a numeric value from a following digit to prevent ambiguity",
          Category: Command_Category.IO,
          Parameters: "None. Functionally equivalent to a space but explicit in code. Example: F1W10STN stores 10 into N without the leading '1' being parsed as part of F1.",
          Query_Form: "",
          Default_Value: "N/A",
          Example: "F1W10STN" ),
        ...
        new Command_Entry (
          Command: "SM",
          Syntax: "SM<mask>",
          Description: "Set service request (SRQ) mask — defines which events cause an SRQ on the HP-IB",
          Category: Command_Category.IO,
          Parameters: "mask: 3-digit octal value. Bits: 001=front panel SRQ, 002=program complete, 004=data ready, 010=trigger too fast, 020=illegal state/syntax error, 040=program memory error, 100=service request bit, 200=limits failure (pass/fail).",
          Query_Form: "",
        ...
        new Command_Entry (
          ...
          Category: Command_Category.IO,
          Parameters: "None. Returns 0 = front terminals active, 1 = rear terminals active.",
          Query_Form: "SW1",
        ...
        new Command_Entry (
          Command: "H",
          Syntax: "H",
          Description: "Home command — restores instrument to the configuration stored as the Home state in program memory",
          Category: Command_Category.System,
          Parameters: "None. If no Home state has been stored, instrument resets to factory default. Does NOT clear program memory (use CL1 to clear and reset).",
          Query_Form: "",
          Default_Value: "N/A",
          Example: "H" ),
        ...
        new Command_Entry (
          Command: "CL1",
          Syntax: "CL1",
          Description: "Clear-continue — resets instrument state and clears program memory, then continues in local/remote mode",
          Category: Command_Category.System,
          Parameters: "None. Equivalent to a Device Clear (DCL) bus command. Resets all settings to factory defaults and erases stored program.",
          Query_Form: "",
          Default_Value: "N/A",
          Example: "CL1" ),
        ...
        new Command_Entry (
          Command: "TE1",
          Syntax: "TE1",
          Description: "Execute self-test — performs analog gain, offset, and digital checks; reports pass/fail result",
          Category: Command_Category.System,
          Parameters: "None. Input terminals must be floating and GUARD switch in the IN position. Returns '100' on pass; displays failing test number on failure. Result also output over HP-IB when instrument is addressed to talk.",
          Query_Form: "",
        ...
        new Command_Entry (
          Command: "L1",
          Syntax: "L1",
          Description: "Begin storing program codes into instrument program memory (load program mode ON)",
          Category: Command_Category.Subprogram,
          Parameters: "None. All subsequent codes sent to the instrument are stored, not executed, until Q (end) is received. The stored program becomes the Home state.",
          Query_Form: "",
          Default_Value: "N/A",
          Example: "L1" ),
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Subprogram,
          Parameters: "None. Terminates the program sequence begun with L1. The instrument returns to normal execution mode.",
          Query_Form: "",
          Default_Value: "N/A",
          Example: "Q" ),
        ...
        new Command_Entry (
          ...
          Category: Command_Category.Subprogram,
          Parameters: "None. Runs the program stored by L1...Q. SRQ bit 002 is set when execution completes, if enabled in SM mask.",
          Query_Form: "",
          Default_Value: "N/A",
          Example: "X1" ),
      };
