...
namespace Multimeter_Controller
{
  partial class Form1
  {
    ...
    private void InitializeComponent()
    {
      ...
      Instruments_Group.Controls.Add( About_Selections_Button );
      Instruments_Group.Controls.Add( label2 );
      Instruments_Group.Controls.Add( Master_Instrument_Combobox );
      ...
      // button1
      // 
      button1.Location = new Point( 126, 236 );
      ...
      Saved_Instruments_Label.Location = new Point( 15, 258 );
